...
tienda_info = ("Bienvenido a TechieStore en Santiago (2025)",)
print(type(tienda_info))
...
print(f"Venta 101: {ventas[0]['cliente']} compró {ventas[0]['cantidad']} {productos[0]['nombre']} y pagó {total_venta_101}")

total_venta_102 = precio_final_2 * ventas[1]["cantidad"]
print(f"Venta 102: {ventas[1]['cliente']} compró {ventas[1]['cantidad']} {productos[1]['nombre']} y pagó {total_venta_102}")

total_venta_103 = precio_final_4 * ventas[2]["cantidad"]
print(f"Venta 103: {ventas[2]['cliente']} compró {ventas[2]['cantidad']} {productos[3]['nombre']} y pagó {total_venta_103}")

total_venta_104 = precio_final_2 * ventas[3]["cantidad"]
print(f"Venta 104: {ventas[3]['cliente']} compró {ventas[3]['cantidad']} {productos[1]['nombre']} y pagó {total_venta_104}")

total_venta_105 = precio_final_5 * ventas[4]["cantidad"]
print(f"Venta 105: {ventas[4]['cliente']} compró {ventas[4]['cantidad']} {productos[4]['nombre']} y pagó {total_venta_105}")
